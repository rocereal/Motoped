        ...
        <div className="row">
          <div className="col-sm-3 logo">
            <a href="#top" onClick={(e) => handleNavClick(e, 'top')} title="Motoped.ro - NIEVE Q-EN">
              <img src="/images/logo-motoped.png" alt="Motoped.ro" className="regular-logo img-fluid" style={{ maxHeight: 90 }} />
              <img src="/images/logo-motoped.png" alt="Motoped.ro" className="sticky-logo img-fluid" style={{ maxHeight: 90 }} />
            </a>
            <div
